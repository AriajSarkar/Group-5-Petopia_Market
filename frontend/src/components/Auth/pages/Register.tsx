...
import GoogleSignInButton from "@/hooks/FirebaseAuth/GoogleSignInButton";
// import { signInWithPopup, auth, googleProvider } from "@/hooks/FirebaseAuth/firebaseConfig";
...
const Register = () => {
    ...
    //         // Assuming you have a function to update the Zustand store with user info
    //         if (user) {
    //             updatePerson(user.uid, user.displayName?.split(' ')[0] || '', user.displayName?.split(' ')[1] || '', user.email || '', { publicId: '', url: user.photoURL || '' });
    //             navigate("/");
    //         }
    //     } catch (error) {
                        ...
                        <div className=" sm:px-8 ">
                            ...
                            >
                                ...
                                {/* <button
                                    ...
                                    className="w-full mt-2 text-white bg-red-500 hover:bg-red-600 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800 flex items-center justify-center"
                                >
                                    <FAIcons.FaGoogle size={20} className="mr-2" />
                                    Sign in with Google
                                </button> */}
